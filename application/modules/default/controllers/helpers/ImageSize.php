 ...
 */
class Zend_Controller_Action_Helper_ImageSize extends Zend_Controller_Action_Helper_Abstract {
	/**
    ...
    function setImage($filename = null, $width = null, $height = null, $color = null) {
        if ($filename) {
