<?php
require_once 'CU/Form/Model/Adapter/Interface.php';
...
class CU_Form_Model_Adapter_Doctrine implements CU_Form_Model_Adapter_Interface
{
	...
	public function saveRecord()
	{
		try {
			$this->_record->save();
		}catch (Doctrine_Query_Exception $dqe){
			print_r($dqe->getMessage());
		}
	}
	...
	public function getRelations()
	{
		...
		foreach($rels as $rel)
		{
			...
			if(is_array($identifier)){
				$relation['id'] = $identifier[0];
			}else{
				$relation['id'] = $identifier; 	
			}
